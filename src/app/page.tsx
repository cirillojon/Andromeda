...
export default function Home() {
  return (
    <div className="grid grid-cols-1 grid-rows-1 items-center justify-center max-w-fit h-full md:grid-cols-2">
      <div className="flex flex-col w-full mt-24 md:mt-0">
      ...
      <div className="flex flex-col h-full md:h-screen items-center justify-center bg-gradient-to-t from-blue-400 to-indigo-200">
        ...
        <div className="flex flex-col items-center -mt-24 -mb-36">
          <div className="flex items-center">
            <Image src="/Hero-House.png" alt="House" width={500} height={20} />
          </div>
        </div>
      </div>
    </div>
