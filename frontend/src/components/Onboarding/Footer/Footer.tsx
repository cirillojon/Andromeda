...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-t from-indigo-400 to-indigo-200 text-white py-8">
      <div className="container mx-auto px-4 text-black">
        <div className="text-left mb-8">
          ...
          <p className="mb-4">Using Andromeda gives you the power to fully customize your project.</p>
