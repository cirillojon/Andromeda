		...
		<div className="grid grid-cols-1 grid-rows-1 max-w-fit h-full md:grid-cols-2 drop-shadow-2xl mt-16">
			<div className="flex flex-col mt-16 mb-14 md:mb-0">
				...
				<div className="flex flex-col items-center text-left">
					...
					We aim to revolutionize the industry by using a tech-forward approach to end 
					homeowner&apos;s reliance salesmen, show transparent financing options, and provide a client portal 
